...
function Doordash_Banner() {
    ...
    <section className="first_section">
        ...
        <div className="InlineChildren">
            ...
            <div className="styles__LogoTextContainer-sc-uv595k-0 hBniDW">
                <svg width="155" height="18" viewBox="0 0 361.1 42" fill="#ffffff">
        ...
        <div>
            <span className="bBZgZV">Restaurants and more, delivered to your door</span>
        </div>

                
        <div className="bnIYnF">
            <div className="iDYccT">
                <div className="sc-df24fc97-1 dSxrAg">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="styles__StyledInlineSvg-sc-12l8vvi-0 jFpckg">
            ...
            <div className="kDtJhE">
            <input aria-autocomplete="list" aria-controls="desktopAddressSearchAutocomplete" aria-expanded="false" type="text" role="combobox" aria-label="Your delivery address" autocomplete="off" placeholder="Enter delivery address" id="FieldWrapper-7" class="gFxa-dk" value=""></input>
            </div>

            <div className="iDYcdb">
                <div className="grDBmE">
                    <button size="16" shape="Circle" kind="BUTTON/PLAIN" aria-label="Find Restaurants" type="button" className="styles__StyledButtonRoot-sc-1ldytso-0 bXhtvi">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="styles__StyledInlineSvg-sc-12l8vvi-0 jFpckg">
        ...
        <a href="https://identity.doordash.com/auth?client_id=1666519390426295040&amp;enable_last_social=false&amp;intl=en-US&amp;layout=consumer_web&amp;prompt=none&amp;redirect_uri=https%3A%2F%2Fwww.doordash.com%2Fpost-login%2F&amp;response_type=code&amp;scope=%2A&amp;state=%2F%7C%7Cc9acbbc2-fd67-4641-a198-92dc30a10eae" className="jojKRj">
                <span className="gNbAOx">Sign in for saved address</span>
        </a>       
...
export default Doordash_Banner;